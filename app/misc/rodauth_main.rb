class RodauthMain < Rodauth::Rails::Auth
  configure do
    ...
    enable :create_account, :verify_account, :verify_account_grace_period,
           ...
           :json, :jwt, :jwt_refresh,
           :reset_password, :change_password, :change_password_notify,
           :change_login, :verify_login_change, :close_account,
           :lockout, :active_sessions, :internal_request
    ...
    # hmac_secret "192002b006512088099324eee9bbebe5262b2cbe7d16ce0110734f0b05ed0980706f865ad0f0a04cdef8878dcdf267f9c7af034bcaa1182a6626c264885f4559"

    # Set JWT secret, which is used to cryptographically protect the token.
    jwt_secret 'aaa748e864cf144917ad28c8aa3c722486730f248e8b3a9e13ae37abe51fb210de08d4df67fc924baa49f28745b300e829a3632320ae10a0b0d2e87ed90e30b0'
